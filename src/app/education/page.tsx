...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#d3e1e6]">
      ...
      <div className="absolute top-0 left-165 p-6 text-center mb-8 absolute w-50 h-40 rounded-b-[50px] bg-gray-600 border-3 border-blue-300 transition-all duration-300 hover:h-32 hover:bg-gray-500">
      ...
      <div>
        ...
        <div className="fixed bottom-0 left-165 right-0 p-6 text-center mb-8 absolute w-50 h-25 rounded-t-[50px] bg-gray-600 border-3 border-blue-300 transition-all duration-300 hover:h-32 hover:bg-gray-500">
