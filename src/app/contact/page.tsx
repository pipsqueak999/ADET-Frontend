  ...
  return (
    <div>
      ...
      <div>
        ...
        <div className="fixed bottom-0 right-49 right-0 p-6 text-center mb-8 absolute w-50 h-25 rounded-t-[50px] bg-gray-600 border-3 border-blue-300 transition-all duration-300 hover:h-32 hover:bg-gray-500">
